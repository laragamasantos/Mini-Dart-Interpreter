...
public class SyntaticAnalysis {
    ...
    private PrintCommand procPrint() {
      ...
      private AssertCommand procAssert() {
        ...
        AssertCommand as = new AssertCommand(line, expr, msg); 
        return as;
    }
    ...
    private IfCommand procIf() { 
        ...
        IfCommand ic = new IfCommand(line, expr, thenCmds, elseCmds);
        return ic;
    }
    ...
    private DoWhileCommand procDoWhile() {
        ...
        DoWhileCommand dwcmd = new DoWhileCommand(line, cmds, expr);
        return dwcmd;
    }
    ...
    private ForCommand procFor() {
        ...
        ForCommand fc = new ForCommand(line, var, expr, cmds);
        return fc;
    }
    ...
    private Expr procExpr() {
        ...
        if (current.type == TokenType.IF_NULL) {
            bop = BinaryOp.IF_NULL;
            advance();
            rhs = procCond();
        }

        if(bop != null){
            lhs = new BinaryExpr(line, lhs, bop, rhs);
        }
    ...
    private Expr procFactor() {
        ...
        int line = lex.getLine();
        if(uop != null){
            UnaryExpr ue = new UnaryExpr(line, expr, uop);
            return ue;
        }
        return expr;
    }
    ...
    private IfListItem procLIf() {
        ...
        IfListItem ili = new IfListItem(line, expr, thenItem, elseItem);
        return ili;
    }
    ...
    private ForListItem procLFor(){
        ...
        ForListItem fli = new ForListItem(line, var, expr, item);
        return fli;
    }
